    ...
    <Styles>
      <section className="home__container">
        ...
        <div className="categories__grid">
          <div
            className="cat1"
            onClick={() => handleSelectCategory("Linguagens")}
          >
            <span>
              Linguagens <img src={arrowIcon1} />
            </span>
            <img
              className="illustration"
              src={illLanguages}
              alt="Ilustração de linguagens"
            />
          </div>
          <div
            className="cat2"
            onClick={() => handleSelectCategory("Matematica")}
          >
            <span>
              Matemática <img src={arrowIcon2} />
            </span>
            <img
              className="illustration"
              src={illMath}
          ...
          <div className="cat3" onClick={() => handleSelectCategory("Leis")}>
            <span>
              Direito <img src={arrowIcon2} />
            </span>
            <img
              className="illustration"
              src={illLaw}
              alt="Ilustração de direito"
            />
          </div>
          <div
            className="cat4"
            onClick={() => handleSelectCategory("Programação")}
          >
            <span>
              Programação <img src={arrowIcon1} />
            </span>
            <img
              className="illustration"
              src={illProg}
